...
2. **Structuring**: A custom data model, `MemoryNode` is created in Firestore. Data is sharded under `users/{userId}/nodes` to ensure privacy and speed.
...
---
## 🛠️ Setup: Deploy Cognistore for yourself!

1. Clone the repository to your local machine.
2. Navigate to the project directory and install the required Flutter dependencies:
   ```bash
   flutter pub get
   ```
3. Launch and test the application locally in your Chrome browser
   ```bash
